...
void menu() {
    ...
    estoque.adicionarProduto(Produto(1, "Camiseta", 50, 29.99));
    estoque.adicionarProduto(Produto(2, "Calca", 30, 79.99));
    estoque.adicionarProduto(Produto(3, "Tenis", 20, 199.99));

    estoque.adicionarFuncionario(Funcionario(1, "Alice", "Gerente"));
    estoque.adicionarFuncionario(Funcionario(2, "Joao", "Caixa"));
